...
// Tue Dec  8 15:46:35 2020 by ROOT version 6.14/04
// from TTree PreSelection/PreSelection
// found on file: dyjets_1200to2500_skim.root
//////////////////////////////////////////////////////////
...
TreeMakerTopiary::TreeMakerTopiary(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("dyjets_1200to2500_skim.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("dyjets_1200to2500_skim.root");
      }
...
void TreeMakerTopiary::Init(TTree *tree)
{
