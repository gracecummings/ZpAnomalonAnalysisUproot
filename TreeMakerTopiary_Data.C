#define TreeMakerTopiary_Data_cxx
#include "TreeMakerTopiary_Data.h"
...
void TreeMakerTopiary_Data::Loop(std::string outputFileName, float totalOriginalEvents, int sampleType)
{
   if (fChain == 0) return;
