...
if __name__=='__main__':
    ...
    samplelist = [#['2021-03-26','Fall17.TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8_new_pmx'],
                  ...
                  #['2021-03-26','ZpAnomalonHZ_UFO-Zp2000-ND175-NS1'],
                  ...
                  ['2021-03-28','Run2018C-17Sep2018-v1.SingleMuon'],
                  ['2021-03-28','Run2018B-17Sep2018-v1.SingleMuon'],
                  ['2021-03-28','Run2018A-17Sep2018-v1.SingleMuon'],
                  #['2021-03-28','Autumn18.DYJetsToLL_M-50_HT-100to200_TuneCP5_PSweights_13TeV-madgraphMLM-pythia'],
                  #['2021-03-28','Autumn18.DYJetsToLL_M-50_HT-200to400_TuneCP5_PSweights_13TeV-madgraphMLM-pythia'],
                  #['2021-03-28','Autumn18.DYJetsToLL_M-50_HT-400to600_TuneCP5_PSweights_13TeV-madgraphMLM-pythia'],
                  #['2021-03-28','Autumn18.DYJetsToLL_M-50_HT-600to800_TuneCP5_PSweights_13TeV-madgraphMLM-pythia'],
                  #['2021-03-28','Autumn18.DYJetsToLL_M-50_HT-800to1200_TuneCP5_PSweights_13TeV-madgraphMLM-pythia'],
                  #['2021-03-28','Autumn18.DYJetsToLL_M-50_HT-1200to2500_TuneCP5_PSweights_13TeV-madgraphMLM-pythia'],
                  #['2021-03-28','Autumn18.DYJetsToLL_M-50_HT-2500toInf_TuneCP5_PSweights_13TeV-madgraphMLM-pythia'],
                  ]
    ...
    for cut in cutlist:
        ...
        for era in eras:
            ...
            if steps["uncs"]:
                subprocess.run(["python","doStackedUncertainty.py","-m",cut[2],"-z",cut[0],"-j",cut[1],"-wp",cut[4],"-date",str(date.today()),"-y",era[0]])

        #stack all  
        if steps["ratios"]:
            #subprocess.run(["python","stackAll.py","-L",era[1],"-x","10.0","-m",cut[2],"-z",cut[0],"-j",cut[1],"-wp",cut[4],"-date",str(date.today()),"-y",era[0]])
            subprocess.run(["python","stackAll.py","-x","10.0","-m",cut[2],"-z",cut[0],"-j",cut[1],"-wp",cut[4],"-date",str(date.today())])
